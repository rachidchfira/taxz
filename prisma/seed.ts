  ...
  const testimonials = await Promise.all([
    db.testimonial.create({
      data: {
        ...
        content: 'After three years of confusion about my tax obligations, TaxFinalization finally gave me clarity. They identified a refund I didn\'t know I was entitled to. Professional, thorough, and worth every dong.',
        rating: 5,
        isVerified: true,
        isPublished: true,
      },
    ...
    db.testimonial.create({
      data: {
        ...
        content: 'Working with multiple employers during the year made my tax situation complex. TaxFinalization aggregated everything correctly and found deductions I would have missed. Very professional service.',
        rating: 5,
        isVerified: true,
        isPublished: true,
      },
