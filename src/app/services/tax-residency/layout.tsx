...
export const metadata: Metadata = {
  title: 'Tax Residency Assessment Vietnam — 183-Day Rule | TaxFinalization',
  ...
  alternates: { canonical: '/services/tax-residency' },
  openGraph: { title: 'Tax Residency Assessment — TaxFinalization', description: 'Official 183-day rule analysis for expats in Vietnam.' },
}
