...
const sections = [
  {
    ...
    content: `TaxFinalization provides Personal Income Tax (PIT) finalization and related services for foreigners in Vietnam, including:
...
Failure to provide accurate or timely information may result in delays, inaccuracies, or additional fees.`
  },
  {
    ...
    content: `TaxFinalization commits to:
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-muted-foreground">
                These Terms of Service govern your use of TaxFinalization's tax services. 
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm leading-relaxed">
                        TaxFinalization's total liability for any claims arising from our services shall not exceed 
                ...
                <CardContent className="p-6">
                  <div className="text-center">
                    <p className="text-sm text-muted-foreground">
                      By engaging TaxFinalization's services, you acknowledge that you have read, understood, 
